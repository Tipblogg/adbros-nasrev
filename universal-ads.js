(function() {
  ...
  async function validatePublisher() {
    ...
    try {
      const response = await fetch('https://cdn.jsdelivr.net/gh/Tipblogg/adbros-nasrev/pubs.json', {
        method: 'GET',
        cache: 'no-cache'
      });
  ...
  function injectAdBranding(slotDiv) {
    try {
      ...
      branding.innerHTML = 'ads by <a href="https://adbros360.com" target="_blank" rel="noopener">Adbros360</a>';
